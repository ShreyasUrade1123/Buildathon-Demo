    ...
    return (
        <div className="flex-1 flex flex-col justify-center items-center text-center -mt-10 pointer-events-none">
            ...
            >
                ...
                <h1 className="text-6xl md:text-9xl font-serif text-[#e8cfa8] tracking-tight leading-[0.9]">
                    <span className="block font-normal text-[#f0ebe3]">MegaLLM</span>
                    <span className="block italic font-light text-[#e8cfa8] opacity-80 text-5xl md:text-7xl mt-2">Buildathon</span>
                </h1>
            </motion.div>
