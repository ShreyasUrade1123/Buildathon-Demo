    ...
    return (
        <div className="flex-1 flex flex-col justify-center items-center text-center -mt-10 pointer-events-none">
            ...
            >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-medium text-[#e8cfa8] tracking-tight leading-[0.9]">
                    <span className="block font-NeueHaasGrotesk font-medium text-[#f0ebe3]">MegaLLM</span>
                    <span className="block italic font-serif text-[#e8cfa8] opacity-80 text-3xl md:text-4xl lg:text-6xl mt-2">Buildathon</span>
                </h1>
            </motion.div>
